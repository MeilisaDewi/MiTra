            ...
            <div class="card-body">
                ...
                <form action="/transaksi/edit/<?= $result['id_transaksi'] ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control <?= $validation->hasError('id_transaksi') ? 'is-invalid' : '' ?>" id="name" name="name" value="<?= old('name', $result['nama']) ?>">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control <?= $validation->hasError('customer_id') ? 'is-invalid' : '' ?>" id="name" name="name" value="<?= old('name', $result['nama']) ?>">
                            <div id="validationServer03Feedback" class="invalid-feedback">
                                <?= $validation->getError('tipe')  ?>
                            </div>
                        </div>
