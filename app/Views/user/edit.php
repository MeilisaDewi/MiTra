                             ...
                             <div class="row mb-3">
                                 <div class="col-md-6">
                                     <div class="form-floating mb-3 mb-md-0">
                                         <input class="form-control <?php if (session('errors.firstname')) : ?>is-invalid<?php endif ?>" name="firstname" type="text" placeholder="Enter you first name" value="<?= old('firstname', $result->firstname ) ?>">
                                 ...
                                 <div class="form-floating">
                                     <input class="form-control <?php if (session('errors.lastname')) : ?>is-invalid<?php endif ?>" name="lastname" type="text" placeholder="Enter your last name" value="<?= old('lastname', $result->lastname) ?>">
                                ...
                                <div class="form-floating mb-3">
                                    ...
                                    endif ?>" name="email" type="email" placeholder="<?= lang('Auth.email') ?>" value="<?=old('email' , $result->email) ?>"/>
                                ...
                                <div class="col-mb-3 mt-3">
                                 <div class="form-floating">
                                     <input class="form-control <?php if (session('errors.lastname')) : ?>is-invalid<?php endif ?>" name="alamat" type="text" placeholder="Enter your addres" value="<?= old('alamat', $result->alamat) ?>">
                                     <label for="inputNo_telpon">Alamat</label>
                                 </div>

                                <div class="col-mb-3 mt-3">
                                 <div class="form-floating">
                                     <input class="form-control <?php if (session('errors.lastname')) : ?>is-invalid<?php endif ?>" name="no_telpon" type="text" placeholder="Enter your number" value="<?= old('no_telpon', $result->no_telpon) ?>">
